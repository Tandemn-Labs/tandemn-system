...
class NodeInfo(BaseModel):
    ...
    cpu_percent: Optional[float] = None # cpu percentage of the node
    ram_percent: Optional[float] = None # ram percentage of the node
...
class Application(BaseModel):
    ...
    app_id:str # unique identifier for the application instance (it should be of the format ApplicationKey+uuid)
