...
ANTHROPIC_API_KEY=sk-ant-...          # Optional; only for the LLM placement advisor
...
**By default, Orca has two built-in placement systems** when you call `orca plan` or `orca deploy`:
